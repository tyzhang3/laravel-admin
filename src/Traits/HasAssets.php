...
trait HasAssets
{
    ...
    public static $baseCss = [
        ...
        'vendor/laravel-admin/AdminLTE/plugins/fontawesome-free/css/v4-shims.min.css',
        ...
        'vendor/laravel-admin/AdminLTE/plugins/overlayScrollbars/css/OverlayScrollbars.min.css',
    ...
    public static $baseJs = [
        ...
        'vendor/laravel-admin/AdminLTE/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js',
